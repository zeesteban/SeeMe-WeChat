...
Page({
  data: {
    ...
    tag_list_geeky: ["Le Wagon", "HTML", "CSS","Smooth", "AR/VR", "Startups", "UX/UI", "Ruby", "Finding the right VPN server", "Meetups", "Orbital Mechanics", "Octocat", "Collecting stickers", "Fizz Buzz", "Chewbacca"],
